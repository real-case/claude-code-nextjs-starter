...
/**
 * Ephemeral UI state (ADR 0023). Zustand holds **only** client-only, transient
 ...
 *       · server-derived data → TanStack Query (0022);
 ...
 *     the Query cache, not here (0022).
 *
 * This module is `"use client"`, so a Server Component importing it fails the
 * build — the boundary in 0023 enforced at the bundler, not just by review.
