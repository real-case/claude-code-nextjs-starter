...
unexpected errors; on the Vercel runtime (**0007**) stdout is captured as logs. Client-facing
...
Builds on **0002** (the App Router boundaries used) and **0007** (Vercel captures stdout
logs). Any future external error-tracking adoption is deferred to its own ADR; logger
configuration may read from the env module (**0020**).
