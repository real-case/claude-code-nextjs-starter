...
/**
 * The one place locales are configured (ADR 0027).
 *
 * Everything locale-aware — the `[locale]` segment, middleware negotiation,
 * navigation helpers, canonical/`hreflang` alternates (ADR 0028) and the
 ...
 * here and the ADR 0054 agent-translation workflow (Phase 12) drafts the other
 * catalogs from it.
 */
export const routing = defineRouting({
  ...
  // locale, which makes the ADR 0028 canonical/`hreflang` alternates
