...
// ADR 0036: the test-runner is the BUILD-INTEGRITY SMOKE engine only. It renders
...
//   - NO axe hook    — accessibility lives in the addon run (ADR 0038);
//   - NO coverage    — coverage is single-sourced from the Vitest projects (ADR 0040).
