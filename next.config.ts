...
const nextConfig: NextConfig = {
  // ADR 0033: the React Compiler owns memoization.
  reactCompiler: true,
  // ADR 0032: type-check navigation against the project's real routes — a
...
// ADR 0027: wire the next-intl request config into the build. The explicit
